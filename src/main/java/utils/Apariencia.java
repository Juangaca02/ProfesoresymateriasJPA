...
public class Apariencia {
	...
	public static void setApariencia(int apariencia) throws Exception {
		...
		case 0: // SO_ANFITRION
			...
			break;
		case 1: // METAL
			UIManager.setLookAndFeel(UIManager.getCrossPlatformLookAndFeelClassName()); // L&F c�silo Java, llamado
																						// "Metal"
			MetalLookAndFeel.setCurrentTheme(new DefaultMetalTheme());
			// MetalLookAndFeel.setCurrentTheme(new OceanTheme());
			break;
		case 2: // GTK
			UIManager.setLookAndFeel("com.sun.java.swing.plaf.gtk.GTKLookAndFeel"); // Look and Feel GTK - S�lo en
																					// entornos Linux, Unix y Solaris
			break;
		case 3: // MOTIF
			UIManager.setLookAndFeel("com.sun.java.swing.plaf.motif.MotifLookAndFeel"); // Look and Feel Motif
			break;
		case 4: // WINDOWS
			UIManager.setLookAndFeel("com.sun.java.swing.plaf.windows.WindowsLookAndFeel"); // Look and Feel Windows -
																							// S�lo en entornos Windows
			break;
		case 5: // OCEAN
	...
	public static void setAparienciasOrdenadas(int apariencias[]) {
		// Por cada apariencia intento ponerla salvo que obtengamos un error, si lo
		// obtengo paso a la siguiente apariencia
		int i = 0;
